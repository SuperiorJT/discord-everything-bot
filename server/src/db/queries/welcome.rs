...
impl WelcomeQueries {
    ...
    pub async fn module_expanded_fetch_by_guild_id(
        &self,
        guild_id: u64,
    ) -> sqlx::Result<WelcomeExpanded> {
    ...
    pub async fn module_insert(&self, data: WelcomeModuleInsert) -> sqlx::Result<WelcomeModule> {
        let row: (i64,) =
            sqlx::query_as(r#"INSERT INTO welcome (guild_id, enabled) VALUES (?, ?) RETURNING id"#)
                .bind(data.guild_id.to_string())
                .bind(data.enabled)
                .fetch_one(&self.pool)
                .await?;
    ...
    pub async fn module_upsert_with(
        &self,
        guild_id: u64,
        data: &WelcomeContent,
    ...
    pub async fn module_join_upsert_with(
        &self,
        welcome_id: i64,
        data: &WelcomeJoinContent,
        exec: impl Executor<'_, Database = Sqlite>,
    ) -> sqlx::Result<()> {
        sqlx::query("
    ...
    pub async fn module_join_dm_upsert_with(
        &self,
        welcome_id: i64,
        data: &WelcomeJoinDmContent,
        exec: impl Executor<'_, Database = Sqlite>,
    ) -> sqlx::Result<()> {
        sqlx::query("
    ...
    pub async fn module_join_roles_upsert_with(
        &self,
        welcome_id: i64,
        data: &WelcomeJoinRolesContent,
        exec: impl Executor<'_, Database = Sqlite>,
    ) -> sqlx::Result<()> {
        sqlx::query(
            "
    ...
    pub async fn module_leave_update_with(
        &self,
        welcome_id: i64,
        data: &WelcomeLeaveContent,
        exec: impl Executor<'_, Database = Sqlite>,
    ) -> sqlx::Result<()> {
        sqlx::query(
            "
